...
export type OverlayLanguage = 'zh-CN' | 'en' | 'ja';
...
const JA_MESSAGES: OverlayMessages = {
  panelAriaLabel: 'OpenJOC オーディオコントローラー',
  detectedTitle: 'JOC オーディオを検出',
  detectedBody: 'この動画には E-AC-3 JOC ストリームが含まれています。',
  dismissDetection: '検出通知を閉じる',
  enable: '有効にする',
  enableOpenJoc: 'OpenJOC を有効にする',
  expandPanel: 'OpenJOC パネルを展開',
  collapsePanel: 'OpenJOC コントローラーを折りたたむ',
  closeErrorPanel: 'エラーパネルを閉じる',
  closeNotice: '通知を閉じる',
  ...
  statusActive: '有効',
  statusEnabled: '有効',
  currentAudio: '現在のオーディオ',
  outputMode: '出力モード',
  rendererStereo: 'ステレオ（スピーカー）',
  rendererBinaural: 'バイノーラル（ヘッドホン）',
  dialnormField: 'プログラムレベル',
  dialnormCalibrated: 'キャリブレーション（推奨）',
  dialnormUnity: 'Unity / 互換モード',
  dialnormCalibratedHelp: '番組の Dialnorm メタデータに従います。',
  dialnormUnityHelp: 'Dialnorm 減衰を無効にし、互換性を優先します。',
  healthAriaLabel: '再生状態',
  healthSync: '映像と音声の同期',
  healthLoudness: '平均ラウドネス',
  waitingForData: 'データを待機中',
  advancedEntry: '詳細',
  advancedEntryHint: '技術情報',
  disableOpenJoc: 'OpenJOC を無効にする',
  advancedDiagnostics: '詳細診断',
  liveSnapshot: 'ライブスナップショット',
  languageField: '言語',
  languageHelp: 'コントローラーの言語を切り替え、選択を記憶します。',
  customGain: 'カスタムゲイン',
  customGainValueAria: 'カスタムゲイン値',
  customGainHelp: '0 dB は元の音量を維持します。大きなブーストはクリップの原因になります。',
  reset: 'リセット',
  diagGroupDecoder: 'デコーダー',
  diagGroupInput: '入力',
  diagGroupProfile: 'プロファイル',
  diagGroupAudio: 'オーディオ',
  diagGroupRealtime: 'リアルタイム',
  diagGroupMemory: 'メモリ',
  diagGroupBinaural: 'バイノーラル',
  diagDecoder: 'デコーダー',
  diagInput: '入力',
  diagStatus: '状態',
  diagProfile: 'プロファイル',
  diagStage: 'ステージ',
  diagSampleRate: 'サンプルレート',
  diagOutputChannels: '出力チャンネル',
  diagRenderer: 'レンダラー',
  diagDrift: '映像と音声のずれ',
  diagLoudness: '平均ラウドネス',
  diagBuffer: 'バッファ',
  diagUnderruns: 'アンダーラン',
  diagDecodeP95: 'デコード p95',
  diagRealtimeFactor: 'リアルタイム係数',
  diagWasmCurrent: 'WASM 現在値',
  diagWasmPeak: 'WASM ピーク',
  diagVirtualLayout: '仮想レイアウト',
  diagHrtf: 'HRTF',
  diagBinauralLatency: 'バイノーラル遅延',
  diagBinauralP95: 'バイノーラル p95',
  waitingForProfile: 'JOC プロファイルを待機中',
  alwaysEnableOpenJoc: '常に OpenJOC を有効にする',
  rawDiagnosticsJson: '生の診断 JSON',
  copyJson: 'JSON をコピー',
  collapseDiagnostics: '詳細診断を隠す',
  copied: 'コピーしました',
  copyFailed: 'コピーに失敗しました。手動で選択してください',
  errorStatus: '再生に失敗しました',
  errorEyebrow: '再生を続行できません',
  errorTitle: 'JOC オーディオをデコードできません',
  errorReasonLabel: '原因',
  errorCodeLabel: 'エラーコード',
  errorDefaultReason: 'OpenJOC は具体的な失敗理由を返しませんでした。',
  errorHint: 'ページを更新して、もう一度お試しください。',
  returnNativeAudio: 'ネイティブオーディオに戻す',
  details: '詳細',
  errorUnderlyingReason: '根本原因',
  errorFailedStage: '失敗したステージ',
  errorNativeDecoder: 'ネイティブ Dolby デコーダー',
  errorNativeDecoderUnused: '未使用',
  errorUnknownStage: '不明',
  errorRateUnsupported: '再生速度が 1.0x ではないため、OpenJOC はまだ対応していません。',
  errorProfileInvalid: 'JOC ストリームを検出しましたが、使用可能な JOC プロファイルがありません。',
  errorMediaUnavailable: 'JOC ストリームを検出しましたが、オーディオセグメントを完全に取得できませんでした。',
  errorDecodeFailed: 'JOC ストリームを検出しましたが、OpenJOC は現在のオーディオをデコードできませんでした。',
  nonJocTitle: 'JOC オーディオが検出されませんでした',
  nonJocBody: 'このページではネイティブオーディオ出力を使用します。',
  nonJocStatus: 'ページのオーディオ状態',
  defaultVirtualLayout: 'デフォルト 7.1.4',
};
