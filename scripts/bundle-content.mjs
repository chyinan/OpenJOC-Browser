...
export function createContentBundle(extensionDirectory) {
  ...
  return [
    ...
    `const __openjocOverlayController = (() => { const {normalizeOutputGainDb, OUTPUT_GAIN_MIN_DB, OUTPUT_GAIN_MAX_DB, OUTPUT_GAIN_STEP_DB} = __openjocOutputGain; const {OVERLAY_LANGUAGE_OPTIONS, isOverlayLanguage, overlayMessage} = __openjocOverlayI18n; const {advanceOverlayState, createOverlayState, needsOverlayMarkupRebuild, overlayRendererLabel, resetOverlayState, OVERLAY_RENDERER_OPTIONS} = __openjocOverlayState; ${controller} return {createJocOverlayController}; })();`,
